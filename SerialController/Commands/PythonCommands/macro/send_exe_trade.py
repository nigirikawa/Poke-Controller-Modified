...
class send_exe_trade(BaseExeTrade):
    ...
    def send_trade(self):
        ...
        # 申し込む
        self.menu_selection("Macro/rokkuman_exe/trade_setting_menu_next_selected.png", [140, 570, 285, 590], "トレード設定画面-申し込み選択")
        print("申し込みを選択しました。")
        ...
        for _ in range(0, 5):
            self.press(Button.START,0.1, 0.5)
        print("枚数順に並べ替えをしました。")
        ...
        # # 画面判定
        # while (datetime.now() - trade_wait_start_time) < timedelta(minutes=1):
        #     # 相手が見つからない
        #     # いいえ→メニューに戻るで初期画面
        ...
        #         self.menu_selection("Macro/rokkuman_exe/trade_list_update.png", [480, 340, 720, 380], "トレードリスト更新")
        #         print("トレードリスト更新開始")
        #         continue # 次のループへ
        #     # 相手が見つかる
        #     # TODO: ここから。相手がいる場合に選択する。
        #     elif self.isContainTemplate("Macro/rokkuman_exe/trade_chip_frame.png", threshold=0.85, crop=[203, 134, 224, 300], use_gray=False):
        #         self.menu_selection("Macro/rokkuman_exe/trade_wait_page_any.png", [1020, 142, 1155, 145], "トレード待機画面")
        #         print("トレードメッセージを選択しました")
